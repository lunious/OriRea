package com.lunioussky.orirea.ui.base;
...
import com.lunioussky.orirea.ui.inter.IBase;
import com.lunioussky.orirea.utils.DialogHelper;
import com.lunioussky.orirea.utils.StatusBarUtil;
import com.lunioussky.orirea.utils.T;
import com.lunioussky.orirea.widget.MultiStateView;
import com.lunioussky.orirea.widget.SimpleMultiStateView;
...
public abstract class BaseActivity<T1 extends BaseContract.BasePresenter> extends SupportActivity implements IBase, BaseContract.BaseView, BGASwipeBackHelper.Delegate {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initInjector(OriApp.getInstance().getApplicationComponent());
        attachView();
    ...
    protected void T(String string) {
        T.showShort(OriApp.getContext(), string);
    }
