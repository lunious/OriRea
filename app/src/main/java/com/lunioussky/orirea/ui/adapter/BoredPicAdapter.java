package com.lunioussky.orirea.ui.adapter;
...
import com.lunioussky.orirea.ui.jandan.ImageBrowseActivity;
import com.lunioussky.orirea.utils.ContextUtils;
import com.lunioussky.orirea.utils.DateUtil;
import com.lunioussky.orirea.utils.ImageLoaderUtil;
import com.lunioussky.orirea.utils.ShareUtils;
import com.lunioussky.orirea.widget.MultiImageView;
import com.lunioussky.orirea.widget.ShowMaxImageView;
    ...
    protected void convert(final BaseViewHolder viewHolder, final JdDetailBean.CommentsBean commentsBean) {
        ...
        switch (viewHolder.getItemViewType()) {
            ...
            case JdDetailBean.CommentsBean.TYPE_SINGLE:
                ...
                imageView.getLayoutParams().height = ContextUtils.dip2px(OriApp.getContext(), 250);
                ...
                ImageLoaderUtil.LoadImage(mContext, commentsBean.getPics().get(0),
                        new DrawableImageViewTarget((ImageView) viewHolder.getView(R.id.img)) {
                            ...
                            public void onResourceReady(Drawable resource, @Nullable Transition<? super Drawable> transition) {
                                ...
                                int pmWidth = ContextUtils.getSreenWidth(OriApp.getContext());
                                int pmHeight = ContextUtils.getSreenHeight(OriApp.getContext());
