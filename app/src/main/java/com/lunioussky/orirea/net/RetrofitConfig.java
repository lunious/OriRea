package com.lunioussky.orirea.net;

import android.support.annotation.NonNull;
import android.util.Log;

import com.lunioussky.orirea.OriApp;
import com.lunioussky.orirea.bean.Constants;
import com.lunioussky.orirea.utils.NetUtil;
...
public class RetrofitConfig {
    ...
    public static final Interceptor sRewriteCacheControlInterceptor = new Interceptor() {
        ...
        public Response intercept(Chain chain) throws IOException {
            ...
            if (!NetUtil.isNetworkAvailable(OriApp.getContext())) {
